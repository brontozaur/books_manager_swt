...
Installing them one by one had no issue.
        ...
        mvn install:install-file -Dfile=libs/swt/current/swt-4.7-cocoa-macosx-x86_64/swt.jar -Dsources=libs/swt/current/swt-4.7-cocoa-macosx-x86_64/src.zip -DgroupId=org.eclipse -DartifactId=swt -Dversion=4.7-cocoa-macosx -Dpackaging=jar;
        mvn install:install-file -Dfile=libs/swt/current/swt-4.7-win32-win32-x86/swt.jar -Dsources=libs/swt/current/swt-4.7-win32-win32-x86/src.zip -DgroupId=org.eclipse -DartifactId=swt -Dversion=4.7-x86 -Dpackaging=jar;
        mvn install:install-file -Dfile=libs/swt/current/swt-4.7-win32-win32-x86_64/swt.jar -Dsources=libs/swt/current/swt-4.7-win32-win32-x86_64/src.zip -DgroupId=org.eclipse -DartifactId=swt -Dversion=4.7-x64 -Dpackaging=jar;
