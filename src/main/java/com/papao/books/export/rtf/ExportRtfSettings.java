...
public final class ExportRtfSettings implements Cloneable {

    private static final Logger logger = Logger.getLogger(ExportRtfSettings.class);
    ...
    public ExportRtfSettings() {

    }

    public ExportRtfSettings cloneObject() {
        ExportRtfSettings clone = null;
        try {
            clone = (ExportRtfSettings) this.clone();
