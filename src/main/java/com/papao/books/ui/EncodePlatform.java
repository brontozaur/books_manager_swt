...
import com.papao.books.ui.custom.CartePersonajTableComposite;
import com.papao.books.ui.custom.CarteReviewComposite;
import com.papao.books.ui.custom.DragAndDropTableComposite;
import com.papao.books.ui.custom.ImageGalleryComposite;
import com.papao.books.ui.custom.PaginationComposite;
...
import com.papao.books.ui.interfaces.IDuplicate;
...
public class EncodePlatform extends AbstractCViewAdapter implements Listener, Observer, IAdd, IModify, IDelete, IRefresh, IDuplicate {
    ...
    private final static int IDX_SUBTITLU = 3;
    private final static int IDX_RATING = 4;
    ...
    private void resetSearchFilters() {
        ...
        ((UnifiedStyledLabelProvider) ((LinkLabelProvider) tableViewer.getLabelProvider(IDX_COLECTIE)).getLabelProvider()).setSearchText("");
    ...
    private void searchInTable(final String text) {
        Display.getDefault().asyncExec(new Runnable() {
            ...
            public void run() {
                ...
                ((UnifiedStyledLabelProvider) ((LinkLabelProvider) tableViewer.getLabelProvider(IDX_COLECTIE)).getLabelProvider()).setSearchText(text);
                ...
                listFilters.add(new ViewerFilter() {
                    ...
                    public boolean select(final Viewer viewer, final Object parentElement, final Object element) {
                        ...
                        return StringUtil.compareStrings(searchTerm,
                                ...
                                || StringUtil.compareStrings(searchTerm, carte.getColectie().toLowerCase());
                    }
                });
                ...
                case IDX_COLECTIE: {
                    AbstractTableColumnViewerSorter cSorter = new AbstractTableColumnViewerSorter(this.tableViewer, col) {
                        ...
                        protected int doCompare(final Viewer viewer, final Object e1, final Object e2) {
                            Carte a = (Carte) e1;
                            Carte b = (Carte) e2;
                            return StringUtil.romanianCompare(a.getColectie(),
                                    b.getColectie());
                        }
                    ...
                    LinkOpener linkHandler = new LinkOpener() {
                        ...
                        public void openLink(Object rowObject) {
                            ...
                            tableViewer.resetFilters();
                            tableViewer.setInput(null);
                            paginationComposite.setColectie(carte.getColectie());
                        }
                    };
                    UnifiedStyledLabelProvider columnLabelProvider = new UnifiedStyledLabelProvider() {
                        @Override
...
//        setBigViewImage(AppImages.getImage32(AppImages.IMG_HOME));
    ...
    public void update(Observable o, Object arg) {
        if (o instanceof BookReadOnlyDetailsComposite) {
            if ("canvas".equals(arg)) {
                CanvasEventDto canvasEventDto = ((BookReadOnlyDetailsComposite) o).getCanvasEventDto();
                if (canvasEventDto == null) {
                    return;
                }
                this.tableViewer.resetFilters();
                tableViewer.setInput(null);
                SimpleTextNode selectedNode = new SimpleTextNode(null, canvasEventDto.getValue());
                selectedNode.setQueryValue(canvasEventDto.getValue());
                Pageable pageable = paginationComposite.getPageable(true);
                ApplicationService.getBookController().requestSearch(canvasEventDto.getSearchType(), selectedNode, pageable);
                return;
            }
