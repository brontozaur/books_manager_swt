...
public final class WelcomePerspective extends Composite {
    ...
    public void addComponents() {
        ...
        this.mainTabFolder = new CTabFolder(upperComposite, SWT.NONE);
    ...
    private Composite createBooksGrid() {
        ...
        final Composite canvas = new Canvas(composite, SWT.NONE);
        canvas.setBackground(ColorUtil.COLOR_FOCUS_YELLOW);
        ...
        ToolBar bar = new ToolBar(canvas, SWT.NONE);
