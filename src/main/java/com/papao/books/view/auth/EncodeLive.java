...
public final class EncodeLive {
	...
	public static long getIdUserCurent() {
		return EncodeLive.id_user;
	}

	public static void setIdUserCurent(final long id) {
		EncodeLive.id_user = id;
	}

	public static boolean isSuperAdmin() {
		return EncodeLive.getIdUserCurent() == Constants.ID_SUPER_ADMIN;
	}

	public static boolean isConsultant() {
		return EncodeLive.getIdUserCurent() == Constants.ID_MAINTENANCE_USER;
	}
