 ...
 *******************************************************************************/
package com.papao.books.view.custom.panel;

import com.papao.books.view.custom.window.SWTUtils;
    ...
    private static void createButtons(final Shell shell) {
        ...
        ok.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(final SelectionEvent e) {
                p.show();
                if (SWTeXtension.displayMessageQ("Confirmation",
                        "Are you sure you want to save this form ?") == SWT.YES) ;
                p.hide();
            }
